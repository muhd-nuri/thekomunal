...
export const events: CommunityEvent[] = [
  {
    ...
    name: "Morehcoustic",
    period: "Ramadan 2025",
    venue: "The Komunal Cafe Bukit Jelutong",
    ...
    posters: [
      {
        ...
        alt: "Morehcoustic poster — Orkes A Hizadin, 14 March 2025, The Komunal Cafe Bukit Jelutong",
        width: 762,
        height: 953,
        tilt: -2,
      },
      {
        ...
        alt: "Morehcoustic poster — Pasca Sini, 14 March 2025, The Komunal Cafe Bukit Jelutong",
        width: 870,
        height: 1087,
        tilt: 1.5,
      },
      {
        ...
        alt: "Morehcoustic poster — Haikal Farid and Fahimi Rahmat, 15 March 2025, The Komunal Cafe Bukit Jelutong",
        width: 836,
        height: 1045,
        tilt: -1,
      },
      {
        ...
        alt: "Morehcoustic poster — headliner to be revealed, 22 March 2025, The Komunal Cafe Bukit Jelutong",
        width: 945,
        height: 1181,
        tilt: 2,
      },
      {
        ...
        alt: "Morehcoustic poster — headliner to be revealed, 28 March 2025, The Komunal Cafe Bukit Jelutong",
        width: 960,
        height: 1201,
        tilt: -1.5,
      },
